...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 2104288424;
                ...
                transform_result_sse::<_, ()>(
                    (move || async move {
                        let output_ok = Result::<_, ()>::Ok(
                            crate::api::cache::music_cache::get_cache_music(&api_music).await,
                        )?;
                        Ok(output_ok)
                    })()
                    .await,
        ...
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, ()>(
                    (move || async move {
                        let output_ok = Result::<_, ()>::Ok(
                            crate::api::cache::music_cache::has_cache_music(&api_music).await,
                        )?;
                        Ok(output_ok)
                    })()
                    .await,
        ...
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, ()>(
                    (move || async move {
                        let output_ok = Result::<_, ()>::Ok({
                            crate::api::music_api::fns::close_db().await;
                        })?;
                        Ok(output_ok)
                    })()
                    .await,
...
fn wire__crate__api__music_api__fns__db_inited_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
        ...
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, ()>(
                    (move || async move {
                        let output_ok =
                            Result::<_, ()>::Ok(crate::api::music_api::fns::db_inited().await)?;
                        Ok(output_ok)
                    })()
                    .await,
                )
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => wire__crate__api__cache__file_cache__cache_file_from_content_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        2 => wire__crate__api__cache__file_cache__cache_file_from_uri_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        3 => wire__crate__api__cache__file_cache__delete_cache_file_with_uri_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        4 => wire__crate__api__cache__file_cache__gen_hash_impl(port, ptr, rust_vec_len, data_len),
        6 => {
            wire__crate__api__cache__fs_util__copy_directory_impl(port, ptr, rust_vec_len, data_len)
        }
        7 => wire__crate__api__cache__fs_util__copy_file_impl(port, ptr, rust_vec_len, data_len),
        8 => wire__crate__api__cache__fs_util__remove_dir_impl(port, ptr, rust_vec_len, data_len),
        9 => wire__crate__api__cache__fs_util__remove_file_impl(port, ptr, rust_vec_len, data_len),
        10 => wire__crate__api__cache__fs_util__rename_impl(port, ptr, rust_vec_len, data_len),
        11 => wire__crate__api__cache__music_cache__cache_music_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        12 => wire__crate__api__cache__music_cache__delete_music_cache_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        13 => wire__crate__api__cache__music_cache__get_cache_music_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        14 => wire__crate__api__cache__music_cache__has_cache_music_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        15 => wire__crate__api__init__init_impl(port, ptr, rust_vec_len, data_len),
        16 => wire__crate__api__init__init_backend_impl(port, ptr, rust_vec_len, data_len),
        17 => wire__crate__api__music_api__fns__close_db_impl(port, ptr, rust_vec_len, data_len),
        18 => wire__crate__api__music_api__fns__db_inited_impl(port, ptr, rust_vec_len, data_len),
        ...
        25 => wire__crate__api__music_api__mirror__music_aggregator_save_to_db_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        26 => wire__crate__api__music_api__mirror__music_aggregator_search_online_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        27 => wire__crate__api__music_api__mirror__music_aggregator_update_order_to_db_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        28 => wire__crate__api__music_api__mirror__music_get_album_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        34 => wire__crate__api__music_api__mirror__music_update_to_db_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        35 => wire__crate__api__music_api__mirror__playlist_add_aggs_to_db_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        36 => wire__crate__api__music_api__mirror__playlist_del_from_db_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        37 => wire__crate__api__music_api__mirror__playlist_fetch_musics_online_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        38 => wire__crate__api__music_api__mirror__playlist_find_in_db_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        39 => wire__crate__api__music_api__mirror__playlist_get_from_db_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        40 => wire__crate__api__music_api__mirror__playlist_get_from_share_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        41 => wire__crate__api__music_api__mirror__playlist_get_musics_from_db_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        42 => wire__crate__api__music_api__mirror__playlist_insert_to_db_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        43 => wire__crate__api__music_api__mirror__playlist_new_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        44 => wire__crate__api__music_api__mirror__playlist_search_online_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        45 => wire__crate__api__music_api__mirror__playlist_update_to_db_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        46 => wire__crate__api__music_api__plugin_fn__music_to_json_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        47 => wire__crate__api__types__config__config_load_impl(port, ptr, rust_vec_len, data_len),
        48 => wire__crate__api__types__config__config_save_impl(port, ptr, rust_vec_len, data_len),
        49 => wire__crate__api__types__extern_api__extern_api_fetch_update_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        50 => wire__crate__api__types__extern_api__extern_api_from_path_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        51 => wire__crate__api__types__extern_api__extern_api_from_url_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        53 => wire__crate__api__types__version__get_release_impl(port, ptr, rust_vec_len, data_len),
        54 => wire__crate__api__utils__crypto__rc4_decrypt_from_base64_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        55 => wire__crate__api__utils__crypto__rc4_encrypt_to_base64_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        56 => wire__crate__api__utils__http_helper__send_request_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        57 => wire__crate__api__utils__path_util__url_encode_special_chars_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        5 => wire__crate__api__cache__file_cache__get_cache_file_from_uri_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        32 => wire__crate__api__music_api__mirror__music_server_length_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        33 => wire__crate__api__music_api__mirror__music_server_to_string_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
